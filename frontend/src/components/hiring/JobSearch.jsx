          ...
          <div className="flex items-center justify-between">
            ...
            {hasActiveFilters && (
              <button
                ...
                className="cursor-pointer inline-flex items-center px-4 py-2 bg-red-50 text-red-600 rounded-xl hover:bg-red-100 transition-all duration-300 text-sm font-medium"
              >
